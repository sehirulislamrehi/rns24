            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="single-featured-post">
                            ...
                            @endif
                            @if( $news->video != NULL )
                            <a href="{{ route('newsdetail', $news->slug) }}" class="video-play"><i class="fa fa-play"></i></a>
                            @endif
                        </div>
                        <!-- Post Contetnt -->
                        <div class="post-content">
                            <div class="post-meta">
                                <a href="{{ route('newsdetail', $news->slug) }}">{{$news->created_at->toDayDateTimeString()}}</a>
                                <a href="{{ route('newsdetail', $news->slug) }}">{{ $category->name }}</a>
                            </div>
